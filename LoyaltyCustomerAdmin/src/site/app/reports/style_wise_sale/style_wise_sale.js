...
(function () {
    angular.module("AppModule")
            .controller("styleWiseController", function ($scope, $filter, $uibModal, $uibModalStack, PrintPane, printService, $rootScope, Factory, $location, Notification) {
                $scope.model = {};
                $scope.model.data = {};
                ...
                var getDetail = "/api/sv/reports/style-wise";
...
//                var getDetailSub = "/api/sv/reports/invoice-wise-sum/";
                ...
                $scope.ui.print = function () {
                    PrintPane.printConfirm("")
                            ...
                            .discard(function () {
                                $scope.printService.printExcel('printDiv', 'Style_Wise_Sales');
                            });
                };
