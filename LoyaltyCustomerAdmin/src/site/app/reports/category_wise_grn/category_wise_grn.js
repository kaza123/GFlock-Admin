...
(function () {
    angular.module("AppModule")
            .controller("categoryWiseGrnController", function ($scope, $filter, $uibModal, $uibModalStack, PrintPane, printService, $rootScope, Factory, $location, Notification) {
                $scope.model = {};
                $scope.model.data = {};
                ...
                var getDetail = "/api/sv/reports/category-wise-grn";
