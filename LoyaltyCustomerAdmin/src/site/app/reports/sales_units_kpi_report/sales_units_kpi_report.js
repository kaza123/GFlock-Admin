(function () {
    angular.module("AppModule")
            .controller("kpiStyleController", function ($scope, $filter, PrintPane, printService, Factory, Notification) {
                $scope.model = {};
                $scope.model.data = {};
                ...
                var getDetail = "/api/sv/reports/sales_units_kpi_report";
                ...
                $scope.ui.print = function () {
                    PrintPane.printConfirm("")
                            ...
                            .discard(function () {
                                $scope.printService.printExcel('printDiv', 'Sales Units KPI Report');
                            });
                };
