...
gulp.task('build-html', function () {
    ...
    return  gulp.src('src/site/**/*.html')
            ...
            .pipe(inject(gulp.src([
                ...
                'src/main/resources/static/styles/other.min.css',
                'src/main/resources/static/styles/other.min.js',
...
gulp.task('build-css', function () {
    ...
    //app
    gulp.src("src/site/styles/theme/**/*.less")
            .pipe(debug())
            .pipe(less())
            .pipe(cleanCSS())
    ...
    gulp.src(["src/site/styles/app/*.less","src/site/styles/app/*.sass"])
            .pipe(debug())
            .pipe(less())
            .pipe(cleanCSS())
...
gulp.task('watch', function () {
    ...
    gulp.watch(['src/site/**/*.css', 'src/site/**/*.less'], ['serve-css']);
});
